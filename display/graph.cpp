...
void GraphPainter::addLineValues(float* values, uint32_t* timestamps, int values_count, char* label) {
    addLineValues(values, timestamps, values_count, label, GraphLineStyle{});
}

void GraphPainter::addLineValues(float* values, uint32_t* timestamps, int values_count, char* label, GraphLineStyle line_style) {
